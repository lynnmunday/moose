...
InputParameters
PorousFlowPermeabilityKozenyCarmanFromVar::validParams()
{
...
PorousFlowPermeabilityKozenyCarmanFromVar::PorousFlowPermeabilityKozenyCarmanFromVar(
...
void
PorousFlowPermeabilityKozenyCarmanFromVar::computeQpProperties()
{
  ...
  _permeability_qp[_qp] =
      permeability * _A * std::pow(_porosity_qp[_qp], _n) / std::pow(1.0 - _porosity_qp[_qp], _m);

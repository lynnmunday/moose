 ...
 */
class PorousFlowPermeabilityKozenyCarmanFromVar : public PorousFlowPermeabilityBase
{
public:
  static InputParameters validParams();

  PorousFlowPermeabilityKozenyCarmanFromVar(const InputParameters & parameters);
...
protected:
  ...
  /// Permeability component multiplier k_ijk in k = k_ijk * A * phi^n / (1 - phi)^m
